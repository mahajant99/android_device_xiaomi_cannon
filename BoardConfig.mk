...
# Bootloader
TARGET_BOOTLOADER_BOARD_NAME := cannong
...
BOARD_PREBUILT_DTBOIMAGE := device/xiaomi/cannon-kernel/dtbo.img
BOARD_CUSTOM_DTBOIMG_MK := $(DEVICE_PATH)/dtbo.mk
BOARD_INCLUDE_DTB_IN_BOOTIMG := true
BOARD_PREBUILT_DTBIMAGE_DIR := device/xiaomi/cannon-kernel
...
BOARD_CANNON_DYNAMIC_PARTITIONS_SIZE := 6084537003
BOARD_CANNON_DYNAMIC_PARTITIONS_PARTITION_LIST := system product
